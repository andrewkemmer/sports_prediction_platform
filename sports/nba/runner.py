...
def run_nba_production(
    *,
    ...
    try:
        ...
        from sports.nba.training import (
            apply_platt,
            fit_final_models,
            fit_platt,
            predict_slate,
        ...
        config_meta = {
            "feature_set_version": "nba-prod-v1",
        ...
        from sports.nba.feature_registry import (
...
def _build_oof_market_rows(oof_ml: pd.DataFrame, oof_dist: pd.DataFrame,
    ...
    from sports.nba.distributions import apply_distribution
...
def _power_rankings_inputs(game_df: pd.DataFrame, study):
    ...
    state."""
    from sports.nba.features import compute_elo, team_events
...
def _write_slate_shap(out_dir: Path, run_date: str, slate: pd.DataFrame,
    ...
    if slate.empty:
        return []
    from sports.nba.training import member_matrix
