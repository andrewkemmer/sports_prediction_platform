"""Tests for production retention execution (core.retention).

Phase 1 review decision 4: retention stays provably dry-run by default;
production runners delete ONLY after successful artifact generation, and
only date-stamped, non-exempt frontend artifacts older than 10 days.
"""
